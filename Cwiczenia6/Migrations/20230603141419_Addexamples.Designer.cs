...
namespace Cwiczenia6.Migrations
{
    ...
    [Migration("20230603141419_Addexamples")]
            ...
            modelBuilder.Entity("Cwiczenia6.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2023, 6, 3, 16, 14, 19, 253, DateTimeKind.Local).AddTicks(261),
                            FirstName = "Bogdan",
                            LastName = "Boner"
                        });
                });
            ...
            modelBuilder.Entity("Cwiczenia6.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 6, 3, 16, 14, 19, 253, DateTimeKind.Local).AddTicks(344),
                            DueDate = new DateTime(2023, 6, 3, 16, 14, 19, 253, DateTimeKind.Local).AddTicks(345),
                            IdDoctor = 1,
                            IdPatient = 1
                        });
                });
