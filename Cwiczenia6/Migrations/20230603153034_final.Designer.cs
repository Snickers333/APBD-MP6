...
namespace Cwiczenia6.Migrations
{
    ...
    [Migration("20230603153034_final")]
    partial class final
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cwiczenia6.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2023, 6, 3, 17, 30, 34, 32, DateTimeKind.Local).AddTicks(9939),
                            FirstName = "Bogdan",
                            LastName = "Boner"
                        });
                });
            ...
            modelBuilder.Entity("Cwiczenia6.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 6, 3, 17, 30, 34, 33, DateTimeKind.Local).AddTicks(24),
                            DueDate = new DateTime(2023, 6, 3, 17, 30, 34, 33, DateTimeKind.Local).AddTicks(26),
                            IdDoctor = 1,
                            IdPatient = 1
                        });
                });
